  ...
  <section class="workspace">
    ...
    <section class="timeline-panel">
      <div class="timeline-head">
        ...
        <div class="sync-state" :class="{ pending: !synced }">
          <span></span>{{ synced ? "Synced just now" : "Changes saved locally" }}
        </div>
      </div>
      <div class="timeline">
      ...
      <button class="add-stop" @click="emit('add')">＋ Add a stop to your day</button>
    </section>
  </section>
</template>
